...
# distilledData$PROPDMGEXP <- unitConverter(distilledData$PROPDMGEXP) 
# distilledData$CROPDMGEXP <- unitConverter(distilledData$CROPDMGEXP)
# Above, don't need apply() since the variables are just lists.
